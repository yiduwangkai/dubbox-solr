...
public class DistanceFunction extends AbstractFunction {
	...
	/**
	 * creates new {@link DistanceFunction.Builder} for sparseness distance {@link DistanceFunction.Power#SPARSENESS_CALCULATION}
	 *
	 * @return
	 */
	...
	/**
	 * creates new {@link DistanceFunction.Builder} for Manhattan (taxicab) Distance {@link DistanceFunction.Power#MANHATTAN_DISTANCE}
	 *
	 * @return
	 */
	...
	/**
	 * creates new {@link DistanceFunction.Builder} for Euclidean Distance {@link DistanceFunction.Power#EUCLIDEAN_DISTANCE}
	 *
	 * @return
	 */
	...
	/**
	 * creates new {@link DistanceFunction.Builder} for Infinite norm distance - maximum value in the vector {@link DistanceFunction.Power#INFINITE_NORM}
	 * 
	 * @return
	 */
