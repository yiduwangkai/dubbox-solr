...
public class Product implements SearchableProduct {
    ...
    public String toString() {
       return String.format("<Product: id=%s, goodsName=%s, storesId=%s, storesName=%s, productSort=%s, " +
               "productParentSort=%s, productSortAll=%s, productSortName=%s, productPacType=%s>",
               id, goodsName, storesId, storesName, productSort, productParentSort, productSortAll, productSortName, productPacType);
