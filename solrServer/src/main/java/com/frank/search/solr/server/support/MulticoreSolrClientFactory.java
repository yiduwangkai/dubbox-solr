...
public class MulticoreSolrClientFactory extends SolrClientFactoryBase {
	...
	/**
	 * Remove SolrClient from factory. Calls {@link org.apache.solr.client.solrj.SolrClient#shutdown()} on remove.
	 *
	 * @param core
	 */
	...
	/**
	 * Get configured {@link org.apache.solr.client.solrj.SolrClient} for specific class tying to determine core name via {@link SolrDocument} or its
	 * class name.
	 *
	 * @param clazz
	 * @return
