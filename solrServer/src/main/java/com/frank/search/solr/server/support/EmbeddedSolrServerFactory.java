 ...
 * loaded via {@link org.springframework.util.ResourceUtils}, therefore it is possible to place them in classpath. Use this class for Testing. It
...
public class EmbeddedSolrServerFactory implements SolrClientFactory, DisposableBean {
	...
	/**
	 * @param solrHome Any Path expression valid for use with {@link org.springframework.util.ResourceUtils} that points to the
	...
	/**
	 * @param path Any Path expression valid for use with {@link org.springframework.util.ResourceUtils}
	...
	/**
	 * Create {@link org.apache.solr.core.CoreContainer} via its constructor (Solr 3.6.0 - 4.3.1)
	 *
