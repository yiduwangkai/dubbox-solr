...
public class Criteria extends Node {
	...
	/**
	 * Crates new {@link Criteria.Predicate} without any wildcards. Strings with blanks will be escaped
	...
	/**
	 * Crates new {@link Criteria.Predicate} without any wildcards for each entry
	 *
	 * @param values
	 * @return
	 */
	...
	/**
	 * Creates new {@link Criteria.Predicate} without any wildcards for each entry
	 *
	 * @param values
	 * @return
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} with leading and trailing wildcards <br/>
	 ...
	 * @param s
	 * @return
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException for strings with whitespace
	 */
	...
	/**
	 * Crates new {@link Criteria.Predicate} with leading and trailing wildcards for each entry<br/>
	 * <strong>NOTE: </strong>mind your schema as leading wildcards may not be supported and/or execution might be slow.
	 *
	 * @param values
	 * @return
	...
	/**
	 * Crates new {@link Criteria.Predicate} with trailing wildcard for each entry
	 *
	 * @param values
	 * @return
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException for strings with whitespace
	...
	/**
	 * Crates new {@link Criteria.Predicate} with leading wildcard for each entry<br />
	 * <strong>NOTE: </strong>mind your schema and execution times as leading wildcards may not be supported.
	 *
	 * @param values
	 * @return
	...
	/**
	 * Crates new {@link Criteria.Predicate} with trailing {@code ~} followed by levensteinDistance
	 *
	 * @param s
	...
	/**
	 * Crates new {@link Criteria.Predicate} with trailing {@code ~} followed by distance
	 *
	 * @param phrase
	 * @param distance
	 * @return
	...
	/**
	 * Crates new {@link Criteria.Predicate} for {@code RANGE [lowerBound TO upperBound]}
	 *
	 * @param lowerBound
	 * @param upperBound
	 * @return
	...
	/**
	 * Crates new {@link Criteria.Predicate} for multiple values {@code (arg0 arg1 arg2 ...)}
	 *
	 * @param values
	 * @return
	 */
	 ...
	 *
	 * @param location {@link org.springframework.data.geo.Point} in degrees
	 * @param distance
	 * @return
	 */
	...
	/**
	 * Creates new {@link Criteria.Predicate} for {@code !bbox} with exact coordinates
	 *
	 * @param box
	 * @return
	 */
	...
	/**
	 * Creates new {@link Criteria.Predicate} for {@code !bbox} for a specified distance. The difference between this and
	 ...
	 * @throws org.springframework.dao.InvalidDataAccessApiUsageException if distance is negative
	 */
	...
	/**
	 * Creates new {@link Criteria.Predicate} for {@code !circle} for a specified distance. The difference between this and
	 * {@link #within(org.springframework.data.geo.Circle)} is this is approximate while {@code within} is exact.
	 *
	 * @param circle
	 * @return
	 * @since 1.2
