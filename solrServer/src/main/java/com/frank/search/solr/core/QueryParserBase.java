...
public abstract class QueryParserBase<QUERYTPYE extends SolrDataQuery> implements QueryParser {
	...
	/**
	 * Create {@link org.apache.solr.client.solrj.SolrClient} readable String representation for {@link CalculatedField}.
	 *
	...
	/**
	 * Create {@link org.apache.solr.client.solrj.SolrClient} readable String representation for {@link Function}
	 *
	 * @param function
	 * @return
	 * @since 1.1
	...
	/**
	 * Append pagination information {@code start, rows} to {@link org.apache.solr.client.solrj.SolrQuery}
	 *
	 * @param query
	 * @param offset
	 * @param rows
	...
	/**
	 * Set {@code q.op} parameter for {@link org.apache.solr.client.solrj.SolrQuery}
	 *
	 * @param solrQuery
	...
	/**
	 * Set {@link org.apache.solr.client.solrj.SolrQuery#setTimeAllowed(Integer)}
	 *
	 * @param solrQuery
	 * @param timeAllowed
	 */
	...
	/**
	 * Set request handler parameter for {@link org.apache.solr.client.solrj.SolrQuery}
	 *
	 * @param solrQuery
	...
	/**
	 * {@link QueryParserBase.PredicateProcessor} creates a solr reable query string representation for a given {@link Criteria.Predicate}
	 *
	 * @author Christoph Strobl
	 */
	...
	/**
	 * Base implementation of {@link QueryParserBase.PredicateProcessor} handling null values and delegating calls to
	...
	/**
	 * Default implementation of {@link QueryParserBase.PredicateProcessor} escaping values accordingly
	 * 
	 * @author Christoph Strobl
	 */
	...
	/**
	 * Handles {@link Criteria}s with {@link Criteria.OperationKey#CONTAINS}, {@link Criteria.OperationKey#STARTS_WITH},
