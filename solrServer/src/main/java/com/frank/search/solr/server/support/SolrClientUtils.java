...
public class SolrClientUtils {
	...
	/**
	 * Create a clone of given {@link org.apache.solr.client.solrj.SolrClient} and modify baseUrl of clone to point to the given core.
	 *
	 * @param solrClient Non null reference {@link org.apache.solr.client.solrj.SolrClient} to copy properties from.
	 * @param core Name of solr core to point to.
	 * @return
	 * @throws org.springframework.beans.BeanInstantiationException if creating instance failed
	 */
